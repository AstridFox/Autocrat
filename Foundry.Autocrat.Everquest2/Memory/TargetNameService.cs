...
namespace Foundry.Autocrat.Everquest2.Memory {
	public class TargetNameService {
		...
		public TargetNameService(Process eq2Process, Eq2 eq2) {
		...
		private void Initialize() {
            ...
            var oldPcProt = Eq2Process.ChangeProtection(pcFunction, 32, ProcessMemoryExtensions.ProtectionType.ExecuteReadWrite);
			var oldNpcProt = Eq2Process.ChangeProtection(npcFunction, 32, ProcessMemoryExtensions.ProtectionType.ExecuteReadWrite);
            ...
            // Restore old protections on jump locations
            Eq2Process.ChangeProtection(pcFunction, 32, (ProcessMemoryExtensions.ProtectionType)oldPcProt);
            Eq2Process.ChangeProtection(npcFunction, 32, (ProcessMemoryExtensions.ProtectionType)oldNpcProt);
