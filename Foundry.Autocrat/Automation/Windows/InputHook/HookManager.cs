...
namespace Foundry.Autocrat.Automation.Windows {
    ...
    internal static partial class HookManager
    {
        ...
        /// </summary>
        internal static event MouseEventHandler MouseMove
        {
            add
            {
        ...
        /// </remarks>
        internal static event EventHandler<MouseEventExtArgs> MouseMoveExt
        {
            add
            {
                EnsureSubscribedToGlobalMouseEvents();
        ...
        /// </summary>
        internal static event MouseEventHandler MouseClick
        {
            add
            {
                EnsureSubscribedToGlobalMouseEvents();
        ...
        /// </remarks>
        internal static event EventHandler<MouseEventExtArgs> MouseClickExt
        {
            add
            {
                EnsureSubscribedToGlobalMouseEvents();
        ...
        /// </summary>
        internal static event MouseEventHandler  MouseDown
        {
            add 
            { 
                EnsureSubscribedToGlobalMouseEvents();
        ...
        /// </summary>
        internal static event MouseEventHandler MouseUp
        {
            add
            {
                EnsureSubscribedToGlobalMouseEvents();
        ...
        /// </summary>
        internal static event MouseEventHandler MouseWheel
        {
            add
            {
                EnsureSubscribedToGlobalMouseEvents();
        ...
        /// </summary>
        internal static event MouseEventHandler MouseDoubleClick
        {
            add
            {
                EnsureSubscribedToGlobalMouseEvents();
        ...
        /// </remarks>
        internal static event KeyPressEventHandler KeyPress
        {
            add
            {
